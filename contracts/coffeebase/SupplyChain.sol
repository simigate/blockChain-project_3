    ...
    RetailerRole
{
    ...
    modifier onlyOwner() {
        require(msg.sender == owner, "The account is not the owner.");
        _;
    }

    // Define a modifer that verifies the Caller
    modifier verifyCaller(address _address) {
        require(msg.sender == _address, "The caller failed verification.");
        _;
    }
    ...
    modifier paidEnough(uint256 _price) {
        require(
            msg.value >= _price,
            "The amount paid is not sufficient to cover the price."
        );
        _;
    }
    ...
    modifier harvested(uint256 _upc) {
        require(
            ...
            "The item didn't finish Harvesting."
        );
        _;
    }
    ...
    modifier processed(uint256 _upc) {
        require(
            ...
            "The item didn't finish Processing."
        );
        _;
    }
    ...
    modifier packed(uint256 _upc) {
        require(
            ...
            "The item didn't finish Packing."
        );
        _;
    }
    ...
    function upload(string _ipfsHash) public onlyOwner {
        // Update the appropriate fields
        ipfsHash = _ipfsHash;
    }
